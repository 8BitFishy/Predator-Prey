...
if __name__ == '__main__':
    ...
    for j in range(1, predatorcount + 1):
        ...
        dir = "C:/Users/Finn Sowerbutts/Documents/Work/Programming/Python/Predator-Prey/vectors/"
        filename = ('{}Actorpredator{}vectors.txt'.format(dir, j))
    ...
    for j in range(1, preycount):
        filename = ('{}Actorprey{}vectors.txt'.format(dir, j))
        preyinstance.id = j
        with open(filename) as f:
            line = f.read().splitlines()
            for k in line:
